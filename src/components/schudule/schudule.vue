    ...
    <el-row>
        <el-col :span="24">
            ...
            <div style="margin-left:60%;margin-top:2%;">
                <span style="background-color:red;width:5px;hight:5px;">法定节假日</span>
                <span style="background-color:green;width:5px;hight:5px;">法定上班</span>
                <span style="background-color:yellow;width:5px;hight:5px;">自定义休息</span>
                <span style="background-color:blue;width:5px;hight:5px;">自定义上班</span>
            </div>
        </el-col>
        <el-col :span="6">
            <div style="max-height: 800px;overflow: auto">
                <el-tree class="fistLvl"
                         :data="firstLvl"
                         :props="props"
        ...
        <el-col :span="50">
            <span  style="width: 60%;margin-left:10%; font-size:20px;">
                <el-button @click="subYear">上一年</el-button>
                <el-button @click="subMonth">上一月</el-button>
                {{resourceName}}---{{currentYear}}年{{currentMonth}}月
                <el-button @click="addMonth">下一月</el-button>
                <el-button @click="addYear">下一年</el-button>
            </span>
            <el-table :data="tableData"  border stripe style="width: 60%;margin-left:30%;" class="blue-table" ref="table" @cell-click="editDate">
        ...
        <el-dialog title="编辑" :visible.sync="dialogVisible" width="30%">
            <div class="dialogFormBox">
                <el-form class="small-space" label-position="left" label-width="100px"
                         ...
                         ref="form"
                         :rules="rules">
                    <el-form-item label="所属资源" prop="organization" v-if="userType==2">
                        <el-select v-model="resourceId" disabled placeholder="请选择">
                            <el-option v-for="item in firstLvl" :key="item.id" :label="item.label" :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
