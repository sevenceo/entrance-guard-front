...
/**
  ...
  * </pre>
  */
import {GetList,GetListInfo, Create, Editor, Delete, BatchDelete, Status, BatchStatus} from "./api/resourceTypeApi";
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                name:
                    [
                        {required: true,max: 128, message: '类型名称不得超过128个字符'}],
                code:
                    [
                        {required: true,max: 128, message: '类型编码不得超过128个字符'}],
    ...
    methods: {
        ...
        onAdd() {
            this.temp = tempInit();
            this.getListInfo(this.pageParam);//上级类型
            /*
            * Other init data
            *
            * */
