...
/**
  ...
  * </pre>
  */
import {GetList, Create, Editor, Delete, BatchDelete, Status, BatchStatus} from "./api/commentsApi";
            ...
            rules: {
                ...
                replyId:
                    [
                            ...
                            {max: 50, message: '回复人员id不得超过50个字符'}],
                replyContent:
                    [

                            {max: 2,000, message: '回复内容不得超过2,000个字符'}],
