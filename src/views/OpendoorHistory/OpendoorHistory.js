...
/**
  ...
  * </pre>
  */
import {GetList, Create, Editor, Delete, BatchDelete, Status, BatchStatus,GetResourceTree,GetSceneList} from "./api/opendoorHistoryApi";
            ...
            rules: {
                ...
                aiServerId:
                    [
                            ...
                            {max: 50, message: 'AI服务器id不得超过50个字符'}],
                humanId:
                    [
                ...
                humanName:
                    [
                            ...
                            {max: 255, message: '人员名称不得超过255个字符'}],
                sceneName:
                    [
                ...
                sensingDeviceId:
                    [
                            {required: true, message: '请输入感应设备id', trigger: 'blur'},
],
                sensingDeviceIp:
                    [
                            {required: true, message: '请输入感应设备ip', trigger: 'blur'},
                            {max: 50, message: '感应设备ip不得超过50个字符'}],
                sensingDeviceName:
                    [
                            {required: true, message: '请输入感应设备名称', trigger: 'blur'},
                            {max: 255, message: '感应设备名称不得超过255个字符'}],
                controlDeviceId:
                    [
                            {required: true, message: '请输入控制设备id', trigger: 'blur'},
],
                controlDeviceIp:
                    [
                            {required: true, message: '请输入控制设备ip', trigger: 'blur'},
                            {max: 255, message: '控制设备ip不得超过255个字符'}],
                controlDeviceName:
                    [
                            {required: true, message: '请输入控制设备名称', trigger: 'blur'},
                            {max: 255, message: '控制设备名称不得超过255个字符'}],
                ldServerNumber:
                    [
