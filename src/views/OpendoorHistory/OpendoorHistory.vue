...
<template>
    <div>
        ...
        <div class="user-filter-container">
          <!--  <el-button class="btn btn-add" type="primary" @click="onAdd" v-authority="'OpendoorHistory.Create'">
                <svg class="icon icon-add1" aria-hidden="true">
                    <use xlink:href="#icon-add1"></use>
                </svg>
                新增
            </el-button>
            <el-button class="btn btn-delete" type="danger" @click="onBatchDelete" v-authority="'OpendoorHistory.BatchDelete'" style="width: 100px;">
                <svg class="icon icon-delete1" aria-hidden="true">
                    <use xlink:href="#icon-delete1"></use>
                </svg>
                批量删除
            </el-button>
            <el-button class="btn btn-add" type="primary" @click="onBatchStatus('0')" v-authority="'OpendoorHistory.BatchStatus'" style="width: 100px;">
                <svg class="icon icon-add1" aria-hidden="true">
                    <use xlink:href="#icon-add1"></use>
                </svg>
                批量启用
            </el-button>
            <el-button class="btn btn-add" type="primary" @click="onBatchStatus('1')" v-authority="'OpendoorHistory.BatchStatus'" style="width: 100px;">
                <svg class="icon icon-add1" aria-hidden="true">
                    <use xlink:href="#icon-add1"></use>
                </svg>
                批量停用
            </el-button>-->
            <el-button class="btn btn-edit" type="primary" @click="onSearch" v-authority="'OpendoorHistory.Search'">
                <svg class="icon icon-add1" aria-hidden="true">
        ...
        <div>
            ...
            <el-table :data="tableData" border stripe style="width: 100%" class="blue-table"
                ...
                <el-table-column type="selection" width="55">
                    ...
                    <el-table-column prop="humanName" label="人员名称">
                    </el-table-column>
                    <el-table-column prop="sceneName" label="场景名称">
                    </el-table-column>
                   <!-- <el-table-column prop="sensingDeviceName" label="感应设备名称">
                    </el-table-column>
                    <el-table-column prop="controlDeviceName" label="控制设备名称">
                    </el-table-column>-->
                    <el-table-column prop="ldServerNumber" label="终端服务器编号">
                    </el-table-column>
                    <el-table-column prop="creationDate" label="开门时间">
                    </el-table-column>
                ...
                <el-table-column prop="type" label="操作" width="130">
                    <template scope="scope">
                        <!--<el-button type="default" title="编辑" class="icon-btn edit" @click="onEdit(scope.row)"
                                   v-authority="'OpendoorHistory.Edit'"
                                   size="small">
                        ...
                        <el-button type="default" title="删除" class="icon-btn delete" @click="onDelete(scope.row)"
                                   v-authority="'OpendoorHistory.Delete'"
                                   size="small">
                            <svg class="icon" aria-hidden="true">
                                <use xlink:href="#icon-delete1"></use>
                            </svg>
                ...
                <div class="dialogFormBox">
                    <el-form class="small-space" label-position="left" label-width="100px"
                            ...
                            <el-form-item label="AI服务器id" prop="aiServerId">
                                    <el-input v-model="temp.ai_server_id"
                                              placeholder="请输入AI服务器id"></el-input>
                            </el-form-item>
                            <el-form-item label="人员id" prop="humanId">
                                    <el-select v-model="temp.human_id" placeholder="请选择">
                                        <el-option
                            ...
                            <el-form-item label="人员名称" prop="humanName">
                                    <el-input v-model="temp.human_name"
                            ...
                            <el-form-item label="感应设备id" prop="sensingDeviceId">
                            ...
                            <el-form-item label="感应设备ip" prop="sensingDeviceIp">
                                    <el-input v-model="temp.sensing_device_ip"
                                              placeholder="请输入感应设备ip"></el-input>
                            </el-form-item>
                            <el-form-item label="感应设备名称" prop="sensingDeviceName">
                                    <el-input v-model="temp.sensing_device_name"
                                              placeholder="请输入感应设备名称"></el-input>
                            </el-form-item>
                            <el-form-item label="控制设备id" prop="controlDeviceId">
                                    <el-select v-model="temp.control_device_id" placeholder="请选择">
                                        <el-option
                                                v-for="item in options"
                                                :key="item.value"
                                                :label="item.label"
                            ...
                            <el-form-item label="控制设备ip" prop="controlDeviceIp">
                                    <el-input v-model="temp.control_device_ip"
                                              placeholder="请输入控制设备ip"></el-input>
                            </el-form-item>
                            <el-form-item label="控制设备名称" prop="controlDeviceName">
                                    <el-input v-model="temp.control_device_name"
                                              placeholder="请输入控制设备名称"></el-input>
                            </el-form-item>
...
-->
            ...
            <el-dialog :visible.sync="searchFormVisible" class="search-dialog" :show-close="false" :modal="false">
                ...
                <!--    <el-form-item label="场景名称" prop="sceneName">
                 ...
                 <!--   <el-form-item label="感应设备名称" prop="sensingDeviceName">
                        <el-input v-model="pageParam.sensingDeviceName"
                                  placeholder="请输入感应设备名称"></el-input>
                    </el-form-item>-->
                    <!--<el-form-item label="控制设备id" prop="controlDeviceId">
                        <el-select v-model="temp.control_device_id" placeholder="请选择">
                  ...
                  <!--  <el-form-item label="控制设备名称" prop="controlDeviceName">
                        <el-input v-model="pageParam.controlDeviceName"
                                  placeholder="请输入控制设备名称"></el-input>
                    </el-form-item>-->
                  <!--  <el-form-item label="终端服务器编号" prop="ldServerNumber">
            ...
            <el-dialog class="dialogForm" title="详情" :visible.sync="opendoorHistoryDetail" @close="closeCompareFaceJson()">
                <el-form :model="jsonData" label-width="80px">
...
<script src="./OpendoorHistory.js"></script>
