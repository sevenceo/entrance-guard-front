    ...
    <div>
        ...
        <el-dialog class="dialogForm" :visible.sync="dialogFormVisible" @close="resetForm">
            <div class="dialogFormBox">
                <el-form class="small-space" :model="temp" ref="temp" :rules="rules" label-position="left" label-width="100px"
                    ...
                    <el-form-item label="语音" prop="serverUrl">
                        <el-upload class="avatar-uploader" :action="upLoadApi"
                                   :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="avatarUpload">
                            <audio ref="audio" controls="controls" v-if="serverUrl" :src="serverUrl"
                                   style="width: 200px;height: 80px;" class="avatar">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button v-if="temp.id" type="primary" @click="update()" :loading="$store.state.app.onXHR">确 定
                </el-button>
                <el-button v-else="!temp.id" type="primary" :loading="$store.state.app.onXHR" @click="create">确 定
                </el-button>
            </div>
        ...
        <el-dialog :visible.sync="searchFormVisible" class="search-dialog" :show-close="false" :modal="false">
            <el-form ref="searchForm">
                ...
                <el-radio-group class="radio-menu" v-model="pageParam.viewMode" @change="getSelectedRadio" >
