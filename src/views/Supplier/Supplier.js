...
/**
  ...
  * </pre>
  */
import {GetList, Create, Editor, Delete, BatchDelete, Status, BatchStatus} from "./api/supplierApi";
            ...
            rules: {
                ...
                supplierName:
                    [
                            ...
                            {required: true,max: 128, message: '供应商名称不得超过128个字符'}],
                supplierCode:
                    [

                            {required: true,max: 128, message: '供应商编码不得超过128个字符'}],
