...
export function GetOutBlackListHuman(humanPageParam) {
    let params;
    if (humanPageParam) {
        params = $.extend({
            //分页信息
    ...
    return fetch({
        url: 'dealer/black-list/getOutBlackListHuman',
        method: 'POST',
        data: humanPageParam
    }).then(function (result) {
        return result.data;
