...
<template>
    <div>
        ...
        <div class="user-filter-container">
            <el-button class="btn btn-add" type="primary" @click="onAdd" v-authority="'SensingControlRef.Create'">
                <svg class="icon icon-add1" aria-hidden="true">
                    <use xlink:href="#icon-add1"></use>
                </svg>
                新增
            </el-button>
            <el-button class="btn btn-delete" type="danger" @click="onBatchDelete" v-authority="'SensingControlRef.BatchDelete'" style="width: 100px;">
                <svg class="icon icon-delete1" aria-hidden="true">
                    <use xlink:href="#icon-delete1"></use>
                </svg>
                批量删除
            </el-button>
            <el-button class="btn btn-add" type="primary" @click="onBatchStatus('0')" v-authority="'SensingControlRef.BatchStatus'" style="width: 100px;">
                <svg class="icon icon-add1" aria-hidden="true">
                    <use xlink:href="#icon-add1"></use>
                </svg>
                批量启用
            </el-button>
            <el-button class="btn btn-add" type="primary" @click="onBatchStatus('1')" v-authority="'SensingControlRef.BatchStatus'" style="width: 100px;">
                <svg class="icon icon-add1" aria-hidden="true">
                    <use xlink:href="#icon-add1"></use>
                </svg>
                批量停用
            </el-button>
            <el-button class="btn btn-edit" type="primary" @click="onSearch" v-authority="'SensingControlRef.Search'">
                <svg class="icon icon-add1" aria-hidden="true">
        ...
        <div>
            ...
            <el-table :data="tableData" border stripe style="width: 100%" class="blue-table"
                ...
                <el-table-column type="selection" width="55">
                    ...
                    <el-table-column prop="sensingDeviceId" label="感应设备id">
                    </el-table-column>
                    <el-table-column prop="controlDeviceId" label="控制设配id">
                    </el-table-column>
                ...
                <el-table-column prop="type" label="操作" width="130">
                    <template scope="scope">
                        <el-button type="default" title="编辑" class="icon-btn edit" @click="onEdit(scope.row)"
                                   v-authority="'SensingControlRef.Edit'"
                                   size="small">
                        ...
                        <el-button type="default" title="删除" class="icon-btn delete" @click="onDelete(scope.row)"
                                   v-authority="'SensingControlRef.Delete'"
                                   size="small">
                            <svg class="icon" aria-hidden="true">
                                <use xlink:href="#icon-delete1"></use>
                            </svg>
                ...
                <div class="dialogFormBox">
                    <el-form class="small-space" label-position="left" label-width="100px"
                            ...
                            <el-form-item label="感应设备id" prop="sensingDeviceId">
                                    <el-input v-model="temp.sensingDeviceId"
                                              placeholder="请输入感应设备id"></el-input>
                            </el-form-item>
                            <el-form-item label="控制设配id" prop="controlDeviceId">
                                    <el-input v-model="temp.controlDeviceId"
                                              placeholder="请输入控制设配id"></el-input>
                            </el-form-item>
                    </el-form>
                </div>
            ...
            <el-dialog :visible.sync="searchFormVisible" class="search-dialog" :show-close="false" :modal="false">
                <el-form v-model="pageParam" labelPosition="">
                        <el-form-item label="感应设备id" prop="sensingDeviceId">
                                <el-input v-model="pageParam.sensingDeviceId"
                                          placeholder="请输入感应设备id"></el-input>
                        </el-form-item>
                        <el-form-item label="控制设配id" prop="controlDeviceId">
                                <el-input v-model="pageParam.controlDeviceId"
                                          placeholder="请输入控制设配id"></el-input>
                        </el-form-item>
                </el-form>
                <div slot="footer" class="dialog-footer">
...
<script src="./SensingControlRef.js"></script>
