...
/**
  ...
  * </pre>
  */
import {GetList, Create, Editor, Delete, BatchDelete, Status, BatchStatus} from "./api/sensingControlRefApi";
            ...
            rules: {
                ...
                sensingDeviceId:
                    [
                            ...
                            {max: 128, message: '感应设备id不得超过128个字符'}],
                controlDeviceId:
                    [
                            {required: true, message: '请输入控制设配id', trigger: 'blur'},
                            {max: 256, message: '控制设配id不得超过256个字符'}],
