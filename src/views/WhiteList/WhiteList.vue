...
<template>
    <div>
        ...
        <div>
                ...
                <el-table-column prop="type" label="操作" width="130">
                    <template scope="scope">
                        <el-button type="default" title="删除" class="icon-btn delete" @click="onDelete(scope.row)"
                                   v-authority="'WhiteList.Delete'" size="small">
            ...
            <!--dialog编辑区-->
            <el-dialog class="dialogForm" title="新增白名单" :visible.sync="dialogFormVisible"
                       @close="resetForm">
                ...
                <div class="">
                    ...
                    <el-button class="btn btn-edit" type="primary" @click="onSearch" v-authority="'WhiteList.Search'">
                        <svg class="icon icon-add1" aria-hidden="true">
