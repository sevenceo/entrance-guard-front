 ...
 * </pre>
 */
import {GetList, Create, Editor, Delete} from "./api/dealerCarPriceApi";
            ...
            rules: {
                ...
                enName:
                    [
                        ...
                        {
                            max: 36,
                            message: '英文名称不得超过36个字符'
                        }],
                officialQuotes:
                    [
                        {required: true, message: '请输入官网指导价', trigger: 'blur'},
                        {
                            max: 36,
                            message: '官网指导价不得超过36个字符'
                        }],
                quotes:
                    [
