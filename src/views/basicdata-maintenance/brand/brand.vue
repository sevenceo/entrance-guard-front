<template>
    <div>
        ...
        <div class="filter-container">
            ...
            <el-button class="btn btn-add" type="primary" @click="onAdd" v-authority="'BrandMaintenance.Create'">
                <svg class="icon icon-add1" aria-hidden="true">
                    <use xlink:href="#icon-add1"></use>
                </svg>
                新增
            </el-button>
            <el-button class="btn btn-add" type="primary" @click="exportAll()" v-authority="'BrandMaintenance.export'" >
                <svg class="icon icon-add1" aria-hidden="true">
                    <use xlink:href="#icon-wendang"></use>
                </svg>
                导出
            </el-button>
            <el-button class="btn btn-edit" type="primary" @click="onSearch"  v-authority="'BrandMaintenance'">
                <svg class="icon icon-add1" aria-hidden="true">
                    <use xlink:href="#icon-filter"></use>
                </svg>
                筛选
            </el-button>
            <el-button class="btn btn-delete" type="danger"  @click="onDel" v-authority="'BrandMaintenance.Remove'">
        ...
        <dataTable :tableData = "formData" @dialogFormVisible = 'edit'  @deleteRow="deleteRow"  v-on:selectionChange="handleSelectionChange"/>
...
<style scoped src="./brand.scss"></style>