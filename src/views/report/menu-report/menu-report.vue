    ...
    <div>
        ...
        <div>
            <el-radio-group size="large" v-model="radio3" @change="changeSelection" class="selection-part">
                <el-radio-button label="菜单点击次数" value="1"></el-radio-button>
                <el-radio-button label="菜单点击人数" value="2"></el-radio-button>
                <el-radio-button label="人均点击次数" value="3"></el-radio-button>
            </el-radio-group>
        ...
        <div class="fans-filter-container">
            <!--<el-button class="btn btn-edit" type="primary" @click="onSearch2">-->
                ...
                <!--筛选-->
            <!--</el-button>-->
            <el-button class="btn btn-add" type="primary" @click="exportAllMenus()" v-authority="'Fans.export'" >
                <svg class="icon icon-add1" aria-hidden="true">
        ...
        <el-table :data="listData" border stripe style="width: 100%" class="blue-table">
            <el-table-column width="200px" prop="parentMenu" label="一级菜单">
            </el-table-column>
            <el-table-column prop="childMenu" label="二级菜单">
            </el-table-column>
            <el-table-column prop="clickCount" label="菜单点击次数">
            </el-table-column>
            <el-table-column prop="clickUser" label="菜单点击人数">
            </el-table-column>
            <el-table-column prop="clickAvg" label="人均点击次数">
            </el-table-column>
        </el-table>
