...
export function Status(id, type) {
    if (type == '1') {
        return fetch({
            url: '/visiting-record/disable/' + id,
            method: 'GET',
        }).then(function (result) {
            Message({
                message: '禁用成功',
