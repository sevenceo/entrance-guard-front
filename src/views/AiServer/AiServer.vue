<template>
    <div>
        ...
        <div class="user-filter-container">
            <el-button class="btn btn-add" type="primary" @click="onAdd" v-authority="'AiServer.Create'">
                <svg class="icon icon-add1" aria-hidden="true">
                    <use xlink:href="#icon-add1"></use>
                </svg>
                新增
            </el-button>
            <el-button class="btn btn-delete" type="danger" @click="onBatchDelete" v-authority="'AiServer.BatchDelete'"
                       style="width: 100px;">
            ...
            <el-button class="btn btn-add" type="primary" @click="onBatchStatus('0')"
                       v-authority="'AiServer.BatchStatus'" style="width: 100px;">
                <svg class="icon icon-add1" aria-hidden="true">
                    <use xlink:href="#icon-add1"></use>
                </svg>
                批量启用
            ...
            <el-button class="btn btn-edit" type="primary" @click="onSearch" v-authority="'AiServer.Search'">
                <svg class="icon icon-add1" aria-hidden="true">
        ...
        <div>
            ...
            <el-table :data="tableData" border stripe style="width: 100%;" class="blue-table"
                ...
                <!--</el-table-column>-->
                <!--<el-table-column prop="clientId" label="客户端唯一标识">-->
                </el-table-column>
                <el-table-column prop="topic" label="订阅主题">
                </el-table-column>
                <el-table-column prop="userName" label="登录名">
                </el-table-column>
                <el-table-column prop="password" label="密码">
                </el-table-column>
                <el-table-column prop="token" label="授权Token">
                </el-table-column>
                <!--<el-table-column prop="libId" label="人脸库分库ID">-->
                <!--</el-table-column>-->
                ...
                <el-table-column prop="type" label="操作" align="center" width="300">
                    <template scope="scope">
                        <el-button type="default" title="编辑" class="icon-btn edit"
                                   @click="onEdit(scope.row)" size="small" v-authority="'AiServer.Edit'">
                            <svg class="icon" aria-hidden="true">
                                <use xlink:href="#icon-edit1"></use>
                            </svg>
                        </el-button>
                        <el-button type="default" title="删除" class="icon-btn delete"
                                   @click="onDelete(scope.row)" size="small" v-authority="'AiServer.Delete'">
                            <svg class="icon" aria-hidden="true">
                                <use xlink:href="#icon-delete1"></use>
                            </svg>
                        </el-button>
                        <el-button type="default" title="查看组织" class="icon-btn edit" :disabled="(scope.row.enabledFlag === 0)"
                                   @click="DetailHumanResourceRef(scope.row)" size="small" v-authority="'AiServer.Resource'">
                            查看组织
                        </el-button>
                        <el-button type="default" title="关联组织" class="icon-btn edit" :disabled="(scope.row.enabledFlag === 0)"
                                   @click="addHumanResourceRef(scope.row)" size="small" v-authority="'AiServer.Resource'">
                            关联组织
                        </el-button>
                    </template>
                </el-table-column>
                    ...
                    <el-form class="small-space" label-position="left" label-width="100px"
                        ...
                        <el-form-item label="授权Token" prop="token">
                            <el-input v-model="temp.token"
                                      placeholder="请输入授权Token"></el-input>
                        </el-form-item>
                        <!--<el-form-item label="人脸库分库ID" prop="libId">-->
                            <!--<el-input v-model="temp.libId"-->
                                      <!--placeholder="请输入人脸库分库ID"></el-input>-->
                        <!--</el-form-item>-->
