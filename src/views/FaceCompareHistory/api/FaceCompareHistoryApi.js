...
export function GetList(page) {
    ...
    return fetch({
        url: '/monitoring/face-compare-history/page',
        method: 'POST',
        data: page
...
export function Editor(data) {
    return fetch({
        url: '/face-compare-history' + data.id,
        method: 'PATCH',
        data: data
    }).then(function (result) {
        if (result) {
...
export function BatchDelete(ids) {
    return fetch({
        url: '/face-compare-history/delete',
        method: 'POST',
        data: ids
    }).then(function (result) {
        Message({
...
export function Status(id, type) {
    if (type == '1') {
        return fetch({
            url: '/face-compare-history/disable/' + id,
            method: 'GET',
        }).then(function (result) {
            Message({
                message: '禁用成功',
        ...
        return fetch({
            url: '/face-compare-history/enable/' + id,
            method: 'GET',
        }).then(function (result) {
            Message({
                message: '启用成功',
...
export function BatchStatus(ids, type) {
    if (type == '1') {
        return fetch({
            url: '/face-compare-history/disable',
            method: 'POST',
            data: ids
        }).then(function (result) {
            Message({
        ...
        return fetch({
            url: '/face-compare-history/enable',
            method: 'POST',
            data: ids
        }).then(function (result) {
            Message({
